<template>
    ...
    <section id="widget-grid" class=" ">
        ...
        <div id="fixed-box">
            <ul id='fixed-ul'>
                <li><a href="#"><p class="fa fa-lg fa-fw fa-bar-chart-o"></p><span class="fixed-li-font">运行状态</span></a></li>
                <li><a href="#"><p class="fa fa-lg fa-fw fa-desktop"></p><span class="fixed-li-font">操作系统</span></a></li>
                <li><a href="#"><p class="fa fa-lg fa-fw fa-cogs"></p><span class="fixed-li-font">JVM</span></a></li>
                <li><a href="#"><p class="fa fa-lg fa-fw fa-globe"></p><span class="fixed-li-font">网络</span></a></li>
            </ul>
        </div>
    </section>
</template>
