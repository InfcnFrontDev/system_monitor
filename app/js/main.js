...
/***/ function(module, exports, __webpack_require__) {
	...
	var _WidgetJvmHeapMemory2 = _interopRequireDefault(_WidgetJvmHeapMemory);

	var _WidgetJvmNonHeapMemory = __webpack_require__(124);

	var _WidgetJvmNonHeapMemory2 = _interopRequireDefault(_WidgetJvmNonHeapMemory);

	var _WidgetJvmMessage = __webpack_require__(129);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./Widget.vue", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./Widget.vue");
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src\\components\\WidgetServerHighLoad.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "./WidgetServerHighLoad.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./WidgetServerHighLoad.vue", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./WidgetServerHighLoad.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $ajax = function $ajax(url, _success, _error) {
	    $.ajax({
	        url: url,
	        cache: false,
	        dataType: 'json',
	        success: function success(data, textStatus, jqXHR) {
	            _success && _success(data, textStatus, jqXHR);
	        },
	...
	var newPromise = function newPromise(type, monitorDate) {
	...
	exports.default = {
	     ...
	     * 获取全部数据
	     */
	    getAll: function getAll(monitorDate) {
	     ...
	     * 获取CPU信息
	     */
	    getCpus: function getCpus(monitorDate) {
	     ...
	     * 获取系统物理内存信息
	     */
	    getMem: function getMem(monitorDate) {
	     ...
	     * 获取操作系统信息
	     */
	    getOperatingSystem: function getOperatingSystem(monitorDate) {
	     ...
	     * 获取系统用户信息
	     */
	    getUsers: function getUsers(monitorDate) {
	     ...
	     * 获取文件系统信息
	     */
	    getFileSystems: function getFileSystems(monitorDate) {
	     ...
	     * 获取网络信息
	     */
	    getNets: function getNets(monitorDate) {
	     ...
	     * 获取目录信息
	     */
	    getDirectorys: function getDirectorys(monitorDate) {
	     ...
	     * 获取JVM类加载信息
	     */
	    getJVMClassLoading: function getJVMClassLoading(monitorDate) {
	     ...
	     * 获取JVM类编译信息
	     */
	    getJVMCompilation: function getJVMCompilation(monitorDate) {
	     ...
	     * 获取JVM垃圾收集信息
	     */
	    getJVMGarbageCollectors: function getJVMGarbageCollectors(monitorDate) {
	     ...
	     * 获取JVM内存信息
	     */
	    getJVMMemoryManagers: function getJVMMemoryManagers(monitorDate) {
	     ...
	     * 获取内存管理器信息
	     */
	    getJVMMemoryPool: function getJVMMemoryPool(monitorDate) {
	     ...
	     * 获取JVM内存池信息
	     */
	    getJVMMemory: function getJVMMemory(monitorDate) {
	     ...
	     * 获取JVM所在操作系统信息
	     */
	    getJVMOperatingSystem: function getJVMOperatingSystem(monitorDate) {
	     ...
	     * 获取JVM运行时参数及其它信息
	     */
	    getJVMRuntime: function getJVMRuntime(monitorDate) {
	     ...
	     * 获取JVM线程相关信息
	     */
	    getJVMThread: function getJVMThread(monitorDate) {
	     ...
	     * 获取Http Request
	     */
	    getHttpRequest: function getHttpRequest(monitorDate) {
	     ...
	     * 获取Http Session
	     */
	    getHttpSession: function getHttpSession(monitorDate) {
	...
	exports.default = {
	    ...
	    data: function data() {
	        return {
	            id: 'jvm_class_load',
	            title: 'jvm类加载',
	            dataApi: _monitor2.default.getJVMClassLoading,
	            option: {
	                tooltip: {
	                    trigger: 'axis'
	                },
	    ...
	    methods: {
	        ...
	        getRealtimeOption: function getRealtimeOption(option, result) {
	            var xAxisData = option.xAxis[0].data,
	                uploadData = option.series[0].data,
	                unloadData = option.series[1].data;
	            var date = new Date();
	            var obj = result.ifcJVMClassLoading;
	        ...
	        getIntervalOption: function getIntervalOption(result) {
	            ...
	            $(result).each(function () {
	                var obj = this.ifcJVMClassLoading;
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src\\components\\WidgetJvmHeapMemory.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "./WidgetJvmHeapMemory.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./WidgetJvmHeapMemory.vue", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./WidgetJvmHeapMemory.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src\\components\\WidgetJvmNonHeapMemory.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "./WidgetJvmNonHeapMemory.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./WidgetJvmNonHeapMemory.vue", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./WidgetJvmNonHeapMemory.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./WidgetJvmMessage.vue", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./WidgetJvmMessage.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
	...
	exports.default = {
	    ...
	    data: function data() {
	        return {
	            id: 'jvm_thread',
	            title: '线程数',
	            dataApi: _monitor2.default.getJVMThread,
	            option: {
	                tooltip: {
	                    trigger: 'axis'
	                },
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    methods: {
	        ...
	        getRealtimeOption: function getRealtimeOption(option, result) {
	            var xAxisData = option.xAxis[0].data,
	                shishiData = option.series[0].data,
	                shouhuData = option.series[1].data;
	            var date = new Date();
	            var obj = result.ifcJVMThread;
